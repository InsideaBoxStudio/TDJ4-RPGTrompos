...
public class CameraFollowPlayers : MonoBehaviour
{
    ...
    public bool inactiveZoom = false;
    ...
    void LateUpdate()
    {
        ...
        if (inactiveZoom == false)
        {
            ...
            if (isPixelPerfect && ppc != null)
            {
                ...
                int targetPPU = Mathf.RoundToInt(Mathf.Lerp(maxZoom * 100, minZoom * 100, t));
        ...
        if (pivot != null)
        {
            pivot.transform.rotation = Quaternion.Lerp(pivot.transform.rotation, targetRotation, rotationSmoothSpeed * dt);
        }
        else
        {
